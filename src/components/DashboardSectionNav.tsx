...
export const DashboardSectionNav: React.FC = () => {
  ...
  return (
    <div className="md:hidden sticky top-[84px] sm:top-[90px] z-20 -mx-3 px-3 py-1 mb-1 backdrop-blur-xl bg-white/90 dark:bg-obsidian-950/90 border-y border-slate-200/80 dark:border-slate-800/80 transition-all shadow-sm">
