        ...
        <div className="flex items-center justify-between h-14 sm:h-16 gap-2">
          ...
          <div className="hidden md:flex items-center bg-slate-100 dark:bg-obsidian-900/90 rounded-xl p-1 border border-slate-200 dark:border-slate-800">
            ...
            <div 
              ...
              className="px-2.5 py-1 flex items-center gap-1.5 text-xs font-semibold text-slate-700 dark:text-slate-200 cursor-pointer hover:text-emerald-500 transition"
            >
